...
export const goldenQuestions: ReadonlyArray<GoldenQuestion> = [
  ...
  {
    id: "q09-recording-locally",
    query: "как мы записываем встречи локально",
    scope: EVAL_PROJECT,
    expected: ["eval-recorder-meeting"],
  },
  {
    id: "q10-diarization",
  ...
  {
    id: "q11-transcription-failure",
    query: "что делаем когда распознавание не удалось",
    scope: EVAL_PROJECT,
    expected: ["eval-recorder-meeting"],
  },
  {
