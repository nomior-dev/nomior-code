...
const makeDesktopClerkLayer = (isDevelopment = true, events: string[] = []) => {
  const environment = DesktopEnvironment.DesktopEnvironment.of({
    ...
    userDataDirName: isDevelopment ? "nomior-dev" : "nomior",
    legacyUserDataDirName: isDevelopment ? "Nomior Code (Dev)" : "Nomior Code (Alpha)",
...
describe("DesktopClerk", () => {
  ...
  it.effect("acquires and releases the SDK bridge with the layer", () => {
    ...
    return Effect.gen(function* () {
        ...
        [
          {
            ...
            passkeys: true,
            renderer: { scheme: "nomior-dev", host: "app" },
          },
        ],
      ]);
      ...
      assert.deepEqual(events, ["setPath:userData:/tmp/app-data/nomior-dev", "createClerkBridge"]);
  ...
  it.each([
    { isDevelopment: true, scheme: "nomior-dev" },
    { isDevelopment: false, scheme: "nomior" },
