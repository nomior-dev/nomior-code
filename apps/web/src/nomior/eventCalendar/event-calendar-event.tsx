/* eslint-disable -- vendored third-party source; see VENDOR.md. */
// @ts-nocheck -- vendored third-party source; see VENDOR.md. It is written
// against a looser tsconfig than this repo's (exactOptionalPropertyTypes,
// noUncheckedIndexedAccess), and hand-fixing it would be lost on every update.
// Its exported types still check at every call site outside this directory.
