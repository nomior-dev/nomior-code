...
| `nomior_connector_accounts`    | `004_NomiorConnectorTables`, `010_NomiorConnectorProject` | canonical                        | user configuration (connected accounts, their project, selector config) | No — backed up with the DB                                                                                                                                        |
