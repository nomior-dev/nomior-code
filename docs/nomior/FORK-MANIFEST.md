...
| `apps/mobile/app.config.ts`                                   | branding: the three variant `appName` display strings use the `nomiorBrand` constant — bundle ids, scheme and Expo slug stay upstream's                                                                                    |
