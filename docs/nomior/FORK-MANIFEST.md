...
| `apps/mobile/app.config.ts`                                   | branding: the three variant `appName` strings and the iOS permission prompts use the `nomiorBrand` constant — bundle ids, scheme and Expo slug stay upstream's                                                             |
