...
2. Create an explicit App ID for `com.nomior.nomiorcode` and enable Associated Domains.
...
- macOS build unsigned when expected signed:
  ...
  - Confirm the provisioning profile belongs to `APPLE_TEAM_ID.com.nomior.nomiorcode` and includes
    Associated Domains.
